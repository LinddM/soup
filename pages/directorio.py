...
def directorio (url, separator_items, separator_parts):
    ...
    mails = url.find_all('a', {'href':re.compile('@ufm.edu')})
    mails_text = []
    for i in mails:
    ...
    table1 = url.find('table',{'class':'tabla ancho100'}).find_all('tr')
    table2 = url.find_all('table',{'class':'tabla ancho100'})[1].find_all('tr') 
    ...
    dean_and_directors = url.find_all('table',{'class':'tabla ancho100 col3'})[1].find_all('tr')
    faculty = {}
    ...
    array = []
    three_column_table = url.findAll('table',{'class':'tabla ancho100 col3'})
